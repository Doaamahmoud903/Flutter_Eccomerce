...
import 'package:eccomerce_app/features/auth/presentation/manager/signup/register_view_model.dart';
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(padding: EdgeInsets.only(top: 24.h),
                        child: Text(AppLocalizations.of(context)!.re_password,
                          style: Theme.of(context).textTheme.displayLarge,),
                      ),
                      SizedBox(height: 20.h,),
                      CustomTextField(
                      ...
                      CustomButton(
                          btnName: AppLocalizations.of(context)!.register,
                          onPressed: registerViewModel.signUp,
